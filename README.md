...
- **왁뿌볼 부수기 게임**: 클릭/터치할 때마다 금이 가고, 7번째에
  부서지는 애니메이션과 함께 랜덤 문구("와그작!", "빠각!" 등)가
  나타나요. 지원 기기에서는 진동 효과도 함께 울려요.
- **localStorage 저장**: 만들기 선택값과 완성된 결과가 브라우저에
  저장되어 새로고침·재방문 시에도 유지돼요.
